...
import { BreadcrumbType, RoutesDataItem } from "@/utils/route";
import BreadCrumbs from "@/components/breadCrumbs/index.vue";
import SelectLang from "@/components/selectLang/index.vue";
import ALink from '@/components/aLink/index.vue';
import RightTopMessage from '@/layout/components/rightTopMessage.vue';
import RightTopUser from "@/layout/components/rightTopUser.vue";
import useTopMenuWidth from "@/composables/useTopMenuWidth";
interface RightTopSetup {
  t: Function;
  topMenuCon: Ref;
  topMenuWidth: Ref;
}
