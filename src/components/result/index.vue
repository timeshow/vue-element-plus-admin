  ...
  <div class="result">
    <div class="result-icon">
      <slot name="icon">
        ...
        <span v-else-if="status === 'success'" class="icon-sys icon-success"
          ><success
        /></span>
        <span v-else-if="status === 'warning'" class="icon-sys icon-warning"
          ><warning
        /></span>
        <span v-else-if="status === 'error'" class="icon-sys icon-error"
          ><error
        /></span>
