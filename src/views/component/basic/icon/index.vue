        ...
        <ul class="icon-list">
            ...
            <li>
                <span
                    ...
                    ><span class="icon-name"
                        >el-icon-picture-outline-round</span
                    ></span
                >
            </li>
            <li>
            ...
            <li>
                <span
                    ...
                    ><span class="icon-name"
                        >el-icon-video-camera-solid</span
                    ></span
                >
            </li>
            <li>
            ...
            <li>
                <span
                    ...
                    ><span class="icon-name"
                        >el-icon-c-scale-to-original</span
                    ></span
                >
            </li>
            <li>
            ...
            <li>
                <span
                    ...
                    ><span class="icon-name"
                        >el-icon-shopping-cart-full</span
                    ></span
                >
            </li>
            <li>
            ...
            <li>
                <span
                    ...
                    ><span class="icon-name"
                        >el-icon-turn-off-microphone</span
                    ></span
                >
            </li>
            <li>
            ...
            <li>
                <span
                    ...
                    ><span class="icon-name"
                        >el-icon-close-notification</span
                    ></span
                >
            </li>
            <li>
            ...
            <li>
                <span
                    ...
                    ><span class="icon-name"
                        >el-icon-goblet-square-full</span
                    ></span
                >
            </li>
            <li>
